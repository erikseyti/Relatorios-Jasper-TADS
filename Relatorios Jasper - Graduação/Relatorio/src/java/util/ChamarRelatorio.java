...
public class ChamarRelatorio {
     ...
     *
     */
    public void imprimeRelatorio(String caminhoRelatorio, HashMap param, String nomeRelatorio) throws IOException, SQLException {

        Connection con = banco.Banco.getInstancia().getConnection();
